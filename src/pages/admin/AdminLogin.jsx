...
export default function AdminLogin() {
  ...
  // ✅ Force empty fields on mount (prevents persisted state / autofill side effects)
  useEffect(() => {
    setEmail("");
    setPassword("");
  }, []);
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-neutral-900/70 border border-neutral-800 rounded-2xl p-8 shadow-xl">
        ...
        {/* ✅ autoComplete off for entire form */}
        <form onSubmit={handleSubmit} className="space-y-4" autoComplete="off">

          {/* ✅ hidden dummy fields to defeat Chrome autofill */}
          <input
            type="text"
            name="fake-username"
